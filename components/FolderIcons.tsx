    ...
    return (
        <View style={{ gap: 4, alignItems: "flex-start" }}>
            ...
            <View
                style={[
                    glyphStyles.line,
                    { width: 15, backgroundColor: color },
                ]}
            />
            <View
                style={[
                    glyphStyles.line,
                    { width: 18, backgroundColor: color },
                ]}
            />
        </View>
    );
...
export function PhotosGlyph({ color }: { color: string }) {
    return (
        <View style={{ width: 30, height: 22 }}>
            ...
            <View
                style={[glyphStyles.mountain, { borderBottomColor: color }]}
            />
        </View>
    );
}
...
export function LinkGlyph({ color }: { color: string }) {
    return (
        <View style={{ width: 30, height: 22, justifyContent: "center" }}>
            <View
                style={[glyphStyles.linkOval, { borderColor: color, left: 2 }]}
            />
            <View
                style={[glyphStyles.linkOval, { borderColor: color, left: 12 }]}
            />
        </View>
    );
}
