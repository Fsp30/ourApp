...
export async function signInWithGoogle(): Promise<boolean> {
    try {
        ...
        // Autentica no Firebase com o mesmo login do Google, em paralelo ao fluxo do Drive.
        if (idToken) {
            try {
                ...
                // Não bloqueia o login do Drive se o Firebase falhar — trata como best-effort por enquanto.
            }
        } else {
            console.log(
